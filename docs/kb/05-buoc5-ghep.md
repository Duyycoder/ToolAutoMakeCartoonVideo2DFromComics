...
Bước 4 dùng FFmpeg ghép các đoạn video cảnh lẻ, file âm thanh thuyết minh và file phụ đề `.ass` thành video sản phẩm hoàn chỉnh `.mp4` trong thư mục `storage/stories/<slug>/video/`.
